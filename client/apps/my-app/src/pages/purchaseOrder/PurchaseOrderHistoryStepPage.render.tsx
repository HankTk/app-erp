...
import { HistoryContainer, EmptyState } from './PurchaseOrderHistoryStepPage.styles';

const COMPONENT_NAME = 'PurchaseOrderHistoryStepPage';
...
interface PurchaseOrderHistoryStepPageRenderProps extends PurchaseOrderHistoryStepProps {
...
export function PurchaseOrderHistoryStepPageRender(props: PurchaseOrderHistoryStepPageRenderProps) {
  const {
    po,
    submitting = false,
    readOnly = false,
