...
import { StepContent } from './OrderShippingInstructionStepPage.styles';

export function OrderShippingInstructionStepPageRender(props: OrderShippingInstructionStepProps) {
  const {
